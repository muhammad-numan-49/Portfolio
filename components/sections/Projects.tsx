    ...
    >
      <div className="space-y-9 md:space-y-10">
        {projects.map((project, index) => (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.2fr)] gap-0">
              {/* Image column */}
              <div className="relative w-full min-h-48 md:min-h-0 md:h-full overflow-hidden">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
              ...
              <div className="p-5 sm:p-6 flex flex-col justify-between min-h-0">
                <div>
                  ...
                  <p className="mt-3 text-[11px] sm:text-xs text-emerald-300/90">
                    {project.impact}
                  </p>
