...
const baseClasses =
  'inline-flex items-center justify-center rounded-full px-4 sm:px-5 py-2.5 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900';

const variants: Record<ButtonVariant, string> = {
  primary:
    'bg-accent text-white shadow-lg shadow-indigo-500/30 hover:bg-accent-soft focus-visible:ring-indigo-400',
  secondary:
